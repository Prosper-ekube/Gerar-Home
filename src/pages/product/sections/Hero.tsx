...
const Hero: React.FC = () => {
    ...
    return (
        <section className='relative pt-24 md:pt-36 pb-16 px-6 lg:px-8 bg-cover bg-center' style={{ backgroundImage: 'url(/path-to-your-hero-image.jpg)' }}>
            <div className='absolute inset-0 bg-[#0a0a0a]/90' />

            <div className='relative z-10 max-w-6xl mx-auto text-center'>
                <h1 className='text-6xl lg:text-8xl font-bold text-white mb-4'>Gerar Smart Homes</h1>
                <p className='text-xl text-[#a8a8a8] mb-8'>Give All You Need</p>
