    ...
    return (
        <section className='bg-gradient-to-br from-[#6f4ccf] to-[#5a3ca8] pb-20 pt-10 lg:pt-20 px-6 lg:px-8 text-center text-white'>
            <div className=' max-w-4xl mx-auto'>
                <h2 className='font-bold mb-6 text-4xl lg:text-5xl'>Ready to Transform Your Home?</h2>
                <p className='mb-8 opacity-90 text-lg'>Join over 50,000 happy customers and experience the future of smart living today</p>
