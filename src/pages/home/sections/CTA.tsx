...
const CTA: React.FC = () => {
    ...
    const buttonPrimary = 'bg-white border-2 border-white cursor-pointer duration-1000 ease-in-out font-semibold hover:-translate-y-1 hover:bg-transparent hover:text-white px-8 py-4 rounded-full text-[#6f4ccf] transition-all'
        ...
        <section className='bg-gradient-to-br from-[#6f4ccf] to-[#5a3ca8] pb-20 pt-10 lg:pt-20 px-6 lg:px-8 text-center text-white'>
            <div className=' max-w-4xl mx-auto'>
                ...
                <div className='flex flex-wrap gap-4 justify-center'>
                    <a className={buttonPrimary} onClick={() => navigate('/product')}>Shop Smart Devices</a>
